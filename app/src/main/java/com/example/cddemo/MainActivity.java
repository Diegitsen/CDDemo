...
import com.example.cddemo.Interfaces.IFragments;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.content_main, bienvenidaFragment).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            frag = new BienvenidaFragment();
            fragmentSeleccionado = true;

        } else if (id == R.id.nav_registrar) {
            frag = new RegistrarUsuarioFragment();
            fragmentSeleccionado = true;

        } else if (id == R.id.nav_usuario) {
            frag = new ConsultaUsuarioFragment();
            fragmentSeleccionado = true;

        } else if (id == R.id.nav_lista) {
            frag = new ConsultaListaUsuariosFragment();
            fragmentSeleccionado = true;

        } else if (id == R.id.nav_desarrollador) {
            frag = new DesarrolladoFragment();
            fragmentSeleccionado = true;
        }
